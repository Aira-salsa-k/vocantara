		...
		<>
			...
			<div className="min-h-screen w-screen overflow-x-hidden bg-gray-100 flex flex-col">
				...
				<section className="bg-white border-b border-gray-200 w-full overflow-x-hidden">
					<div className="w-full px-8 sm:px-6 lg:px-8 py-4">
						<div className="flex flex-col sm:flex-row justify-center items-center gap-3" >
							<button
								className="w-full sm:w-full max-w-[250px] h-10 px-8 py-2 rounded-md bg-indigo-600 text-white font-semibold hover:bg-gray-900 transition text-sm text-center"
							...
							<button
								...
								disabled={loading}
								className="w-full sm:w-full max-w-[250px]  h-10 px-4 py-2 rounded-md text-white bg-red-500 hover:bg-black font-semibold disabled:opacity-50 transition text-sm text-center"
							>
								Clear All
							</button>
						</div>
				...
				<section className="max-w-lg mx-auto mt-8 mb-8 w-full">
    ...
    // style={{ width: "70%" }} // contoh progress 70%
				...
				<main className="flex-grow py-4">
					...
					<div className="mt-12 flex flex-col gap-8 lg:flex-row lg:gap-8 max-w-5xl mx-auto">
						...
						<section className="flex-1 bg-white shadow rounded-xl  mb-20">
							{/* ...isi Latihan Merangkai Kalimat */}
							<section className="mt-12 max-w-230 mx-auto bg-white shadow rounded-xl p-6 mb-30">
